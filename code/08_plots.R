...
p = map_ci %>% 
  ...
  labs(x = "Mean Arterial Pressure (mmHg)", 
       y = expression("Cardiac Index (L/min/" * m^2 * ")"), title = "Patients with at least 5 minutes in range n (%)") + 
...
p = 
  ...
  labs(x = "Total Minutes in Range", y = expression("Quartile of Cardiac Index (L/min/" * m^2 * ")")) + 
  scale_y_continuous(breaks=seq(0, 360, 60), limits = c(0, 180)) + 
  theme_light(base_size = 20) + 
  theme(legend.position = "none")

png(here::here("manuscript", "figures", "ci_quartiles.png"),
    width = 10, height = 8, units = "in", res = 350)
p
dev.off() 
...
png(here::here("manuscript", "figures", "ci_map_min_in_range.png"),
    width = 10, height = 8, units = "in", res = 350)
p
dev.off() 
...
png(here::here("manuscript", "figures", "ci_map_min_in_range_cpb.png"),
      width = 10, height = 8, units = "in", res = 350)
p
dev.off() 
...
png(here::here("manuscript", "figures", "univariate_reg.png"),
    width = 10, height = 8, units = "in", res = 350)
p
dev.off() 
...
png(here::here("manuscript", "figures", "adjusted_reg.png"),
    width = 10, height = 8, units = "in", res = 350)
p
dev.off() 
...
png(here::here("manuscript", "figures", "cpb_reg.png"),
    width = 10, height = 8, units = "in", res = 350)
p
dev.off()
...
png(here::here("manuscript", "figures", "tertile_reg.png"),
    width = 10, height = 8, units = "in", res = 350)
p
dev.off()
...
png(here::here("manuscript", "figures", "quintile_reg.png"),
    width = 10, height = 8, units = "in", res = 350)
p
dev.off()
